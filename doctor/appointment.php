...
WHERE doctor.docid = $userid AND appointment.status = 'pending'";
                            ...
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        <a href="approve-appointment.php?id='.$appoid.'" " class="non-style-link">
                                    <button class="btn-primary-soft btn button-icon btn-approve"
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            $sql = "UPDATE appointment SET status = 'approved' WHERE appoid = ?";
        
            // Prepare the statement
            if ($stmt = $conn->prepare($sql)) {
                // Bind the appointment ID (ensure it's an integer type)
                ...
                if ($stmt->affected_rows > 0) {
                    ...
                    echo "Failed to approve the appointment. Please check if the appointment exists.";
                }
            ...
            // Redirect to appointments page after the operation
